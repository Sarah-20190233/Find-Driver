...
import com.example.demo.Controller.Customer_controller;
import com.example.demo.Controller.Driver_controller;
            ...
            if (choice == 0) {
                ...
                if (password.equals("123")) {
                    do {
                        ...
                        // System.out.println("7. Add areas");
                       ...
                       admin.add_discount_on_specific_area(ride3, destination);
                ...
                if (email.contains("@")) {
                    ...
                    if (nationalid.length() == 14) {
                        ...
                        if (license.length() == 14) {
                            //admin.add_to_pendings(d);
                            admin.dataBase.pendings.add(d);
                            //dataBase.drivers.add(userName);
                        ...
                        do {
                            ...
                            if (answer == 1) {
                                ...
                                while (true) {
                                    ...
                                    int flag = 0;
                                    if (ans.equalsIgnoreCase("yes")) {  // Ride Ride=new Ride(); 
                                        for (Ride r : ride.dataBase.rides) {
                                            if (r.getSource().equalsIgnoreCase(Ride.getSource()) && r.getDestination().equalsIgnoreCase(Ride.getDestination())) {
                                                // System.out.println(ride.getdiscount(r.getPrice()));
                                        ...
                                        if (ans.equalsIgnoreCase("yes")) {
                                            ...
                                            for (Ride r : ride.dataBase.rides) {
                                                if (r.getPrice() == Input && r.getSource().equalsIgnoreCase(Ride.getSource()) && r.getDestination().equalsIgnoreCase(Ride.getDestination())) {
                                                    ...
                                                    //r.setPrice(ride.getdiscount(r.getPrice()));
                                                    //System.out.println(r.getCustomer());
                                                    //sara allaaaaa

                                                    //r.setCustomer(customer.getUserName());
                                                    //sara alaaa
                                                    flag = 1;
                                                }
                                            }
                            ...
                            break;*/
                                    ...
                                    //yasmin
                                    /* System.out.println("do you want to show our system offers for this ride ? (yes/no)");                    
                    ans = input.next();
                    int bool = 0;
                    if(ans.equalsIgnoreCase("yes"))
                    {                        
